	...
	return (
		<>
			...
			<KeyboardCard
				...
				oldPrice={13999}
				images={[
					{image: `https://user-images.githubusercontent.com/6285554/84393842-13960900-ac37-11ea-811e-65db2948ca73.jpg`},
					{image: `https://user-images.githubusercontent.com/6285554/53640050-6203dc00-3c6e-11e9-9434-5591ed3e414f.jpg`},
				]}
				description={`Элегантная 6х4 + 4 клавиши сплит ортогональная клавиатура с красивым дизайном`}
