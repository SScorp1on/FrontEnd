...
const description = () => (
	...
	>
		<Text>
			...
			Она имеет 68 клавиш. Данное количество клавиш идеально подходит для работы, учебы и игры.
		</Text>
		<Space h={`sm`}/>
		<Text>
			Особенностью этой клавиатуры является то, что она имеет крайне большое количество клавиш. Здесь можно
