								...
								<Timeline color={`red`} active={4} bulletSize={24} lineWidth={2}>
									...
									<Timeline.Item bullet={<Ship size={12}/>} title={`Доставка`} lineVariant={`dashed`}>
										<Text size="sm" style={{width: `500px`}}>
											...
											самое
											важное - платы. Их делают на заказ отдельно под каждую клавиатуру, а потом на
											корабле
									...
									<Timeline.Item bullet={<Tool size={12}/>} title={`Сборка`}>
										<Text size="sm" style={{width: `500px`}}>
											...
											всей
											клавиатуры ее необходимо поместить в корпус. Когда
											клавиатура
									...
									<Timeline.Item bullet={<Package size={12}/>} title={`Упаковка`}
										...
										<Text size="sm" style={{width: `500px`}}>
											...
											в коробку.
											Такая
											собранная коробка относится в службу доставки и начинается ожидание ее
											обработки и
											отправки
										</Text>
									</Timeline.Item>
