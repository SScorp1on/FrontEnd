						...
						<Timeline color={`red`} active={4} bulletSize={24} lineWidth={2}>
							...
							<Timeline.Item bullet={<Package size={12}/>} title={`Упаковка`} lineVariant={`dashed`}>
								<Text size="sm" style={{width: `400px`}}>
									...
									в коробку. Туда еще нужно положить предметы, входящие в набор каждой клавиатуры.
									Такая
									собранная коробка относится в службу доставки и начинается ожидание ее обработки и
									отправки
								</Text>
							</Timeline.Item>
